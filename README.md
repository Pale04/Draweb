...
| /draweb-api/users/{id}/drawings | POST | Save a new drawing |  |  |
| /draweb-api/users/drawings/{id} | GET  | Retrieve a specific drawing by its ID |  |  |
| /draweb-api/users/{id}/drawings | GET  | Retrieve all drawings of a user |  |  |
